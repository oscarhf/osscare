...
@Path("/numberofdownloads")
public class NumberOfDownloads {
	...
	public Response getNoP() throws Exception {
		...
		String result =objJSonMeasure.jSonMessure("numberofdownloads",objMHTAdapter.getSingleMeasure("single_measures", "numberOfDownloads"), "eclipse");
