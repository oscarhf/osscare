...
@Path("/numberofopenedbugs")
public class NumberOfOpenedBugs {
	@GET
	...
	public Response getNoP() throws Exception {
		...
		String result =objJSonMeasure.jSonMessure("numberofopenedbugs",objMHTAdapter.getCollectionMeasureList("opened_bugs_date"), "eclipse");
