...
@Path("/numberofchangedfiles")
public class NumberOfChangedFiles {
	@GET
	...
	public Response getNoP() throws Exception {
		...
		String result =objJSonMeasure.jSonMessure("numberofchangedfiles",objMHTAdapter.getCollectionMeasureList("changed_files_date"), "eclipse");
