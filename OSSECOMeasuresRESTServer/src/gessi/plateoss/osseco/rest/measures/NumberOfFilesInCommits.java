...
@Path("/numberoffilesincommits")
public class NumberOfFilesInCommits {
	@GET
	...
	public Response getNoP() throws Exception {
		...
		String result =objJSonMeasure.jSonMessure("number_of_files_in_commits",objMHTAdapter.getCollectionMeasureList("files_commit_date"), "eclipse");
