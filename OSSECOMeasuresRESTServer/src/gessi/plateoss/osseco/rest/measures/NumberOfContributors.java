...
@Path("/numberofcontributors")
public class NumberOfContributors {
	@GET
	...
	public Response getNoP() throws Exception {
		...
		String result =objJSonMeasure.jSonMessure("numberofcontributors",objMHTAdapter.getCollectionMeasureList("number_of_contributors_date"), "eclipse");
