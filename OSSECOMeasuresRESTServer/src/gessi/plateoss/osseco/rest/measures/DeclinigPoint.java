...
public class DeclinigPoint {
	...
	public Response getNoP() throws Exception {
		...
		String result =objJSonMeasure.jSonMessure("decliningPoint",objMHTAdapter.getSingleMeasure("single_measures", "decliningPoint"), "eclipse");
