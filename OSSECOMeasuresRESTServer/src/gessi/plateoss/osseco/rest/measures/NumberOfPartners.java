...
@Path("/numberofpartners")
public class NumberOfPartners {
	...
	public Response getNoP() throws Exception {
		...
		String result =objJSonMeasure.jSonMessure("numberofpartners",objMHTAdapter.getSingleMeasure("single_measures", "numberOfPartners"), "eclipse");
