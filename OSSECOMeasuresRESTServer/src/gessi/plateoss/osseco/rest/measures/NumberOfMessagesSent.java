...
@Path("/numberofmessagessent")
public class NumberOfMessagesSent {
	@GET
	...
	public Response getNoP() throws Exception {
		...
		String result =objJSonMeasure.jSonMessure("numberofmessagessent",objMHTAdapter.getCollectionMeasureList("messages_sent_date"), "eclipse");
