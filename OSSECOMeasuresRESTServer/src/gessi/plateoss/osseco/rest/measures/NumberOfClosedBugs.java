...
@Path("/numberofclosedbugs")
public class NumberOfClosedBugs {
	@GET
	...
	public Response getNoP() throws Exception {
		...
		String result =objJSonMeasure.jSonMessure("numberofclosedbugs",objMHTAdapter.getCollectionMeasureList("closed_bugs_date"), "eclipse");
