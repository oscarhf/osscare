 ...
 * @author Oscar Franco-Bedoya (<a
 *         href="oscarhf2002@hotmail.com">oscarhf2002.@hotmail.com</a>)
 */
public class DateLastReleaseCrawler extends WebCrawler {
	private static final Logger logger = LoggerFactory
			.getLogger(VersionHistoryCrawler.class);
	...
	public boolean shouldVisit(Page referringPage, WebURL url) {
		...
		// return true;
		return href.equals("https://projects.eclipse.org/projects/eclipse");
		// return !FILTERS.matcher(href).matches() &&
		// href.startsWith("repository.html");
