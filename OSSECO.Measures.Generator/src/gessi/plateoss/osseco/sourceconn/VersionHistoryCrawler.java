...
*/
public class VersionHistoryCrawler  extends WebCrawler {
 ...
 */
	...
	public boolean shouldVisit(Page referringPage, WebURL url) {
		...
		return !FILTERS.matcher(href).matches() && href.contains("downloads");
	...
	public void visit(Page page) {
		...
		if (html.contains("<title>Eclipse Project Archives")) {
