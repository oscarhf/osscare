 ...
 */
public class DateLastCommitCrawler extends WebCrawler {
	...
	public boolean shouldVisit(Page referringPage, WebURL url) {
		...
		// return true;
		if (href.equalsIgnoreCase("https://git.eclipse.org/c/")) {
			System.out.println("-----------------------------------------------------VISITADA URL: " + url);
			return true;
		} else {
			return false;
		}
